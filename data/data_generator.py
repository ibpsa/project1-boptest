...
class Data_Generator(object):
    ...
    def __init__(self,
        ...
        time_since_epoch = self.datetime_index.view('i8')/1e9
    ...
    def generate_weather(self):
        ...
        from a .mos and applies the transformations
        carried out by the ReaderTMY3 model of the
        IBPSA Modelica Library using OpenModelica via OMPython.

        The IBPSA Modelica Library must be on the MODELICAPATH.
        OpenModelica and OMPython must be installed.
        ...
        if not found:
            raise ValueError('Add the IBPSA Modelica Library to your MODELICAPATH')
