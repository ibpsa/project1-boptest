within ;
model SimpleRC_OnlyReadSignalExchangeBlocks
  "A simple thermal R1C1 model with sinusoidal outside air temperature and heating input with only read signal exchange blocks"
