...
- Changed ``bestest_hydronic`` and ``bestest_hydronic_heat_pump`` Modelica implementation. Instead of extending IDEAS model, they now duplicate it to simplify dependencies.  This is for [#680](https://github.com/ibpsa/project1-boptest/issues/680).
