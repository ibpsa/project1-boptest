...
- Update API call ``get_html_IO.py`` to run with the latest API implemtnation by adding ``['payload']``. This is for [#487](https://github.com/ibpsa/project1-boptest/issues/487).
