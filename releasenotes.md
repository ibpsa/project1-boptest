...
- Add a warning message upon test case compilation in ``data/data_manager.py`` that is displayed if any of the weather variables in ``data/categories.json`` is not in ``wrapped.fmu/resources/weather.csv``. This is for [#500](https://github.com/ibpsa/project1-boptest/issues/500).
