...
model ThermalZone "Reference Thermal zone model Milan"
  ...
  Buildings.ThermalZones.Detailed.MixedAir roo(
    ...
    AFlo=Afloor,
    datConBou(
      layers={roof,AptSep,ElevatorSep},
    ...
    datConExtWin(
      ...
      til={Z_},
      azi={S_}),
    lat(displayUnit="rad") = 0.7937268746)
    "Night zone APT 25 E06 Merezzate+"
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic roof(nLay=7,
    absIR_a=0.9,
    absIR_b=0.9,
    absSol_a=0.6,
    absSol_b=0.6,
    material={Buildings.HeatTransfer.Data.Solids.Generic(
        ...
        nStaRef=Buildings.ThermalZones.Detailed.Validation.BESTEST.nStaRef)})
                           "Roof"
    annotation (Placement(transformation(extent={{66,84},{80,98}})));
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic IntWall(
    ...
    annotation (Placement(transformation(extent={{46,64},{60,78}})));
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic AptSep(
    nLay=7,
    absIR_a=0.9,
    absIR_b=0.9,
    absSol_a=0.6,
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic ElevatorSep(
    nLay=5,
    absIR_a=0.9,
    absIR_b=0.9,
    absSol_a=0.6,
  ...
  Modelica.Blocks.Math.MultiSum Qint(k={Afloor/1000,Afloor/1000,Afloor/1000}, nu=3)
  ...
  IBPSA.Utilities.IO.SignalExchange.Read TsupFloHea(description=
  ...
  IBPSA.Utilities.IO.SignalExchange.Read MFloHea(description=
  ...
  IBPSA.Utilities.IO.SignalExchange.Read TavgFloHea(description=
  ...
  Modelica.Blocks.Sources.RealExpression avgTfloHea(y=(Tfloor.T +
        RadiantSlab.con_a[1].T[1] + RadiantSlab.con_a[1].T[2])/3)
...
equation
  ...
  connect(matrixGain.y, roo.qGai_flow) annotation (Line(points={{-5.5,67},{0,67},
          {0,68},{4,68},{4,27},{32.8,27}},
                                     color={0,0,127}));
  connect(temRet.T, TretFloHea.u) annotation (Line(points={{40,-87.4},{40,-80},{
          98,-80},{98,-81},{103,-81}},                    color={0,0,127}));
  connect(temSup.T, TsupFloHea.u) annotation (Line(points={{-27,-87.4},{-28,-87.4},
          {-28,-53},{103,-53}},
        color={0,0,127}));
  connect(mflowTotin.m_flow, MFloHea.u) annotation (Line(points={{-8,-87.4},{-8,
          -66},{102,-66},{102,-67},{103,-67}},              color={0,0,127}));
  connect(avgTfloHea.y, TavgFloHea.u) annotation (Line(points={{75,-48},{100,-48},
          {100,-39},{103,-39}},          color={0,0,127}));
