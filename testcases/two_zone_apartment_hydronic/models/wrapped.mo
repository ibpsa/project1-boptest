model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput thermostatDayZon_reaTsetZon_y(unit="K") = mod.thermostatDayZon.reaTsetZon.y "Setpoint temperature for thermal zone";
	...
	Modelica.Blocks.Interfaces.RealOutput thermostatNigZon_reaTsetZon_y(unit="K") = mod.thermostatNigZon.reaTsetZon.y "Setpoint temperature for thermal zone";
