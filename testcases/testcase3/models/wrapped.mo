model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput PHeaCooSou_y(unit="W") = mod.PHeaCooSou.y "Heater / Cooler power of south zone";
	...
	Modelica.Blocks.Interfaces.RealOutput PHeaCooNor_y(unit="W") = mod.PHeaCooNor.y "Heater / Cooler power of north zone";
	...
	// Original model
	TwoZones mod(
		oveActSou(uExt(y=oveActSou_u),activate(y=oveActSou_activate)),
		oveActNor(uExt(y=oveActNor_u),activate(y=oveActNor_activate))) "Original model with overwrites";
