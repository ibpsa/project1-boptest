...
model whoBui96 "EnergyPlus FMU for Model Exchange"
  ...
  Modelica.Icons.SignalBus weaBus
    annotation (Placement(transformation(extent={{-28,92},{-12,108}}),
        iconTransformation(extent={{-28,92},{-12,108}})));
...
equation
  connect(X_w.y, fmuZonTopFlr.X_w) annotation (Line(points={{-67,54},{-14,54},{-14,
          -46},{18,-46}},
                        color={0,0,127}));
  connect(fmuZonTopFlr.m_flow[1], mIn_flow.y) annotation (Line(points={{18,-51},
          {-8,-51},{-8,10},{-67,10}},
                                    color={0,0,127}));
  ...
  connect(mOut_flow.y, fmuZonTopFlr.m_flow[2]) annotation (Line(points={{-29,30},
          {-10,30},{-10,-49},{18,-49}},
                                      color={0,0,127}));
  connect(fmuZonTopFlr.QGaiRad_flow, QGaiRad_flow.y) annotation (Line(points={{18,-58},
  ...
  for numZon in 1:5 loop
    ...
    connect(neg[5+numZon].u, fmuZonTopFlr[numZon].QCon_flow)
      annotation (Line(points={{58,-30},{50,-30},{50,-48},{41,-48}},
                                        color={0,0,127}));
  ...
  annotation (Line(points={{-120,0},{-16,0},{-16,-42},{18,-42}},
                                        color={0,0,127}));
  ...
  annotation (Line(points={{120,0},{50,0},{50,-48},{41,-48}},
                                        color={0,0,127}));
  ...
  annotation (Line(points={{120,0},{96,0},{96,-52},{41,-52}},
                                        color={0,0,127}));
  ...
  annotation (Line(points={{120,0},{50,0},{50,-70},{-59,-70}},
                                        color={0,0,127}));
  ...
  annotation (Line(points={{-20,100},{-14,100},{-14,80},{-2,80}},
                                        color={255,204,51}));
  connect(weaBus.TWetBul, TWetBul.u)
  annotation (Line(points={{-20,100},{30,100},{30,80},{38,80}},
                                        color={255,204,51}));
  connect(weaBus.relHum, relHum.u)
  annotation (Line(points={{-20,100},{68,100},{68,80},{78,80}},
                                        color={255,204,51}));
  ...
  connect(OccSch.y, Occ)
    annotation (Line(points={{-19,-90},{50,-90},{50,0},{120,0}},
                                        color={0,0,127}));
  connect(building.weaBus, weaBus) annotation (Line(
      points={{-60,80},{-30,80},{-30,100},{-20,100}},
      color={255,204,51},
      thickness=0.5));
