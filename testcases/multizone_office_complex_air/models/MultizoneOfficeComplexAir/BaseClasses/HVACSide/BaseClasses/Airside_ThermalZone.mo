...
model Airside_ThermalZone "Air side system"
  ...
  MultizoneOfficeComplexAir.BaseClasses.HVACSide.BaseClasses.AirsideFloor_ThermalZone
    floor1(
    duaFanAirHanUni(
      Coi_k=0.1,
      MixingBox_k=0.1,
    ...
    zoneName={"Core_bot","Perimeter_bot_ZN_1","Perimeter_bot_ZN_2","Perimeter_bot_ZN_3","Perimeter_bot_ZN_4"})
  ...
  MultizoneOfficeComplexAir.BaseClasses.HVACSide.BaseClasses.AirsideFloor_ThermalZone
    ...
    zoneName={"Core_mid","Perimeter_mid_ZN_1","Perimeter_mid_ZN_2","Perimeter_mid_ZN_3","Perimeter_mid_ZN_4"})
    annotation (Placement(transformation(extent={{114,20},{164,62}})));
  ...
  MultizoneOfficeComplexAir.BaseClasses.HVACSide.BaseClasses.AirsideFloor_ThermalZone
    ...
    zoneName={"Core_top","Perimeter_top_ZN_1","Perimeter_top_ZN_2","Perimeter_top_ZN_3","Perimeter_top_ZN_4"}) "Top Floor"
    annotation (Placement(transformation(extent={{114,20},{164,62}})));
...
equation
  ...
  connect(peoCou[1:5].y, floor1.nPeo) annotation (Line(points={{-99,20},{94,20},
          {94,35.75},{112.438,35.75}},                  color={0,0,127}));
  connect(peoCou[11:15].y, floor3.nPeo) annotation (Line(points={{-99,20},{94,
          20},{94,35.75},{112.438,35.75}},                       color={0,0,127}));
  connect(peoCou[6:10].y, floor2.nPeo) annotation (Line(points={{-99,20},{94,20},
  ...
  connect(OccSch.y, reaToBooOcc.u)
    annotation (Line(points={{-99,100},{-62,100}}, color={0,0,127}));
