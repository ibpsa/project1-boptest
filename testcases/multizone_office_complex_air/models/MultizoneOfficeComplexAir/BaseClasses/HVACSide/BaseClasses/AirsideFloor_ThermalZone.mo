...
model AirsideFloor_ThermalZone
  "Thermal zones and corresponding air side HVAC systems"
  ...
  MultizoneOfficeComplexAir.BaseClasses.HVACSide.BaseClasses.Component.AirSide.ZoneTerminal.FiveZoneVAV_ThermalZone
    fivZonVAV(
    redeclare package MediumAir = MediumAir,
