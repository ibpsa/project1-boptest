...
model HVAC_ThermalZone
  "Full HVAC system that contains the air side and water side systems"
  extends MultizoneOfficeComplexAir.BaseClasses.HVACSide.BaseClasses.Airside_ThermalZone(
      alpha=1.25,
      sou(nPorts=3),
      floor1(
...
equation
  ...
  connect(building.weaBus, weaBus) annotation (Line(
      points={{120,110},{120,120},{200,120},{200,-120},{40,-120}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
