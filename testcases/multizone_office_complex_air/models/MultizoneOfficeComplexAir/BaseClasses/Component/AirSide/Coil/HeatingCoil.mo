...
model HeatingCoil
  extends
    MultizoneOfficeComplexAir.BaseClasses.Component.AirSide.Coil.BaseClasses.WatCoil;
  parameter Modelica.Units.SI.Efficiency eps(max=1) = 0.8
    "Heat exchanger effectiveness";

  MultizoneOfficeComplexAir.BaseClasses.Component.AirSide.Coil.BaseClasses.DryCoil
    coi(
    ...
    eps=eps) annotation (Placement(transformation(extent={{-18,-34},{20,8}})));
equation
  ...
  connect(coi.TAirLea,pI.mea)  annotation (Line(
      points={{21.9,-17.2},{58,-17.2},{58,-60},{-92,-60},{-92,14},{-82,14}},
      color={0,0,127},
