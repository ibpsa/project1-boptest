  ...
  package Devices "\"Models for capturing the dynamics at the device level\""
    package AirSide "\"Models for device level components\""
      package Coil "\"Component used for modelling fans and pumps\""
        ...
        model cooCoi "The model of the cooling coil"
      ...
      package MixingBox
        ...
        model MixingBox "The model of the mixing box"
      ...
      package Terminal
        package BaseClasses
          ...
          model VAV_advance_temp_sensor "The model of the VAV terminals."
    ...
    or CO2Concentration";
          ...
          equation
            ...
            connect(m_flow.port_b, port_b) annotation (Line(
                ...
                color={0,140,72},
                thickness=0.5));
            connect(oveZonLoc.yReaHea_out, rehVal.y) annotation (Line(points={{
                    -47,50},{-40,50},{-40,44},{-32,44}}, color={0,0,127}));
    ...
    package AirHanUnit
      ...
      package BaseClasses
        ...
        model DuaFanAirHanUnit "AHU with supply/return fans and cooling coil."
          ...
          MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.FlowMover.BaseClasses.WithoutMotor retFan(redeclare
              package
              Medium = MediumAir,
            HydEff=HydEff,
            MotEff=MotEff,
          ...
          MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.FlowMover.VAVSupFan supFan(
            redeclare package Medium = MediumAir,
            TimCon=1,
            k=Fan_k,
            Ti=Fan_Ti,
          ...
          Modelica.Fluid.Interfaces.FluidPort_b port_b_Air(redeclare package
            ...
            "Fluid connector b (positive design flow direction is from port_a to port_b)"
            annotation (Placement(transformation(extent={{90,-10},{110,10}})));
          MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Coil.cooCoi cooCoi(
            redeclare package MediumAir = MediumAir,
            redeclare package MediumWat = MediumWat,
            mAirFloRat=mAirFloRat,
            mWatFloRat=mWatFloRat,
          ...
          MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.MixingBox.MixingBox mixingBox(
        ...
        equation
          connect(cooCoi.port_b_Air, supFan.port_a) annotation (Line(
              ...
              color={0,140,72},
              thickness=0.5));
          connect(mixingBox.TMix, disTSet) annotation (Line(points={{-60,-12},{
...
<p> First implementation.</p>
    ...
    package HydDisturbution
      model ThreZonNetWor "Water distribution network"
      ...
      model FivZonVAV "Thermal zones and VAV terminals."
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Subsystems.HydDisturbution.FivZonNetWor ReheatWatNet(
          redeclare package Medium = MediumWat,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Subsystems.HydDisturbution.FivZonNetWor AirNetWor(
          redeclare package Medium = MediumAir,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.BaseClasses.VAV_advance_temp_sensor vAV1(
          zonNam="cor",
          redeclare package MediumAir = MediumAir,
          redeclare package MediumWat = MediumWat,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.BaseClasses.VAV_advance_temp_sensor vAV2(
          zonNam="sou",
          redeclare package MediumAir = MediumAir,
          redeclare package MediumWat = MediumWat,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.BaseClasses.VAV_advance_temp_sensor vAV3(
          zonNam="eas",
          redeclare package MediumAir = MediumAir,
          redeclare package MediumWat = MediumWat,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.BaseClasses.VAV_advance_temp_sensor vAV4(
          zonNam="nor",
          redeclare package MediumAir = MediumAir,
          redeclare package MediumWat = MediumWat,
        ...
        MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.BaseClasses.VAV_advance_temp_sensor vAV5(
          zonNam="wes",
          redeclare package MediumAir = MediumAir,
          redeclare package MediumWat = MediumWat,
...
First implementation.
  ...
  package Systems
    model Floor "Thermal zones and corresponding air side HVAC systems"
      ...
      MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Subsystems.AirHanUnit.BaseClasses.DuaFanAirHanUnit duaFanAirHanUni(
        numTemp=5,
        redeclare package MediumAir = MediumAir,
        ...
        mFreAirFloRat=(mAirFloRat1 + mAirFloRat2 + mAirFloRat3 + mAirFloRat4 +
            mAirFloRat5)*0.3,
        UA=-(mAirFloRat1 + mAirFloRat2 + mAirFloRat3 + mAirFloRat4 +
            mAirFloRat5)*(1000*17)/
      ...
      MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Subsystems.HydDisturbution.FivZonVAV fivZonVAV(
        redeclare package MediumAir = MediumAir,
      ...
      MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.Controls.ZonCon zonVAVCon[5](
...
<p>See the model <a href=\"modelica://MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.Controls.ZonCon\">MultizoneOfficeComplexAir.BaseClasses.BuildingControlEmulator.Devices.AirSide.Terminal.Controls.ZonCon</a> for a description of the zone terminal VAV controller. </p>
</html>",     revisions = "<html>
<ul>
<li> August 17, 2023, by Xing Lu, Sen Huang, Lingzhe Wang:
<p> First implementation.</p>
    ...
    model ChillerPlant "Chiller plant, chilled water pump system, and cooling towers"
    ...
    equation
      ...
      Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-280,-140},{240,
        ...
        __Dymola_experimentSetupOutput,
        Documentation(info="<html>
<p>The chilled water systems composed of three chillers, three cooling towers, a primary chilled water loop with three constant speed pumps, a secondary chilled water loop with two variable speed pumps, and a condenser water loop with three constant speed pumps.</p>
<p align=\\\"center\\\">
  <img alt=\\\"ChillerControl.\\\"
  src=\"modelica://MultiZoneOfficeComplexAir/../../doc/images/ChillerControl.PNG\" width=800>
</p>
<p><br>The number of operating chillers is determined via a state machine based on the thermal load (Q, kW), rated chiller cooling capacity of chiller k (cck, kW), threshold to start chiller k+1 (&xi;k = 0.9), and waiting time (30 min). The maximum operating chiller number is N, which is equal to 3. </p>
