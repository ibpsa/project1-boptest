...
model ChillerPlant
  ...
  Component.FlowMover.Pump.PumpSystem pumSecCHW(
    ...
    m_flow_nominal={sum(mCHW_flow_nominal)/m for i in linspace(1, m, m)},
    dpValve_nominal(displayUnit="Pa") = {dP_nominal*0.5 for i in linspace(1, m,
      m)},
  ...
  Component.FlowMover.Pump.SimPumpSystem pumPriCHW(
    ...
    n=n,
    Motor_eta={Motor_eta for i in linspace(1, n, n)},
    Hydra_eta={Hydra_eta for i in linspace(1, n, n)},
