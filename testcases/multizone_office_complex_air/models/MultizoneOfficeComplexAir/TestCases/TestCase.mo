...
model TestCase "Complex HVAC systems include air side systems, water side systems, and five thermal zones on each floor. "
  ...
  MultizoneOfficeComplexAir.BaseClasses.LoadSide.LoadWrapper loaEPlus(whoBui(
        bui(spawnExe="spawn-0.3.0-8d93151657"))) "Load calculation in EnergyPlus using Spawn, note this version spawn-0.3.0-8d93151657 is specified for BOPTEST environment; 
...
equation
  ...
  connect(loaEPlus.dryBul, hvac.TDryBul) annotation (Line(points={{11,-34},{20,
          -34},{20,-2},{11.4,-2}}, color={0,0,127}));
  connect(loaEPlus.wetBul, hvac.TWetBul) annotation (Line(points={{11,-31},{18,
          -31},{18,-6.85},{11.35,-6.85}}, color={0,0,127}));

  connect(hvac.TZon, loaEPlus.Tem) annotation (Line(points={{-11,0},{-20,0},{-20,
