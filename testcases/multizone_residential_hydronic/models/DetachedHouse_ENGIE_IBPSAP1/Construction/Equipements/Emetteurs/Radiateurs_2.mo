...
model Radiateurs_2
 ...
 package MediumW = Buildings.Media.Water "Medium model";
  ...
  Regulation.Regul_Ch_2_bis regul_chauffage(Khea=1)
    annotation (Placement(transformation(extent={{-82,58},{-48,72}})));
...
equation
  ...
  connect(regul_chauffage.T, T) annotation (Line(points={{-83.9429,65},{
          -90.2,65},{-90.2,36},{-120,36}},
                                       color={0,0,127}));
  ...
  connect(regul_chauffage.Consigne_Ch, ConsigneCh) annotation (Line(
        points={{-83.9429,69.6667},{-92.9715,69.6667},{-92.9715,70},{-120,
          70}}, color={0,0,127}));
  connect(regul_chauffage.weaBus, weaBus) annotation (Line(
      points={{-75.6857,72},{-76,72},{-76,80}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}}));
  connect(regul_chauffage.yHea, val1.y) annotation (Line(points={{
          -45.5714,65},{-40,65},{-40,32}}, color={0,0,127}));
  annotation (
