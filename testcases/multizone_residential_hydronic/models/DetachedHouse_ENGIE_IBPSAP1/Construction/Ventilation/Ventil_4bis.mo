...
<p>Une ventilation est prise en compte, d&eacute;finie par un flux d&apos;air avec : </p>
<ul>
<li>un d&eacute;bit d&eacute;finit en entr&eacute;e</li>
<li>une temp&eacute;rature correspondant &agrave; la temp&eacute;rature de l&apos;air ext&eacute;rieur</li>
</ul>
</html>"));
end Ventil_4bis;
