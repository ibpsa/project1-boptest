...
equation
  ...
  connect(schedules_RT2012_MI.LightRT12, product3.u1) annotation (Line(
        points={{-12,55.7818},{-2,55.7818},{-2,56},{8,56},{8,-47.2},{42.4,
          -47.2}}, color={0,0,127}));
  connect(schedules_RT2012_MI.OtherLoadsRateRT12, product4.u1) annotation (
      Line(points={{-12,46.4727},{-4,46.4727},{-4,46},{6,46},{6,-67.2},{
          42.4,-67.2}}, color={0,0,127}));
...
<p>Adaptation des profils RT2012 de la maison individuelle pour les zones de jour (salon, cuisine)</p>
</html>"));
