model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealInput conHeaLiv_oveTSetHea_u(unit="K", min=283.15, max=368.15) "Air temperature heating setpoint for Liv";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaRo2_oveTSetHea_u(unit="K", min=283.15, max=368.15) "Air temperature heating setpoint for Ro2";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaBth_oveTSetHea_u(unit="K", min=283.15, max=368.15) "Air temperature heating setpoint for Bth";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaRo1_oveTSetHea_u(unit="K", min=283.15, max=368.15) "Air temperature heating setpoint for Ro1";
	...
	Modelica.Blocks.Interfaces.RealInput conHeaRo3_oveTSetHea_u(unit="K", min=283.15, max=368.15) "Air temperature heating setpoint for Ro3";
