model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealInput oveMixValSup_u(unit="1", min=0.0, max=1.0) "Actuator signal for 0three-way mixing valve controlling supply water temperature to radiators";
	Modelica.Blocks.Interfaces.BooleanInput oveMixValSup_activate "Activation for Actuator signal for 0three-way mixing valve controlling supply water temperature to radiators";
	...
	Modelica.Blocks.Interfaces.RealOutput conCooLiv_reaCoo_y(unit="1") = mod.conCooLiv.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Liv";
	...
	Modelica.Blocks.Interfaces.RealOutput conCooRo3_reaCoo_y(unit="1") = mod.conCooRo3.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Ro3";
	...
	Modelica.Blocks.Interfaces.RealOutput conCooBth_reaCoo_y(unit="1") = mod.conCooBth.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Bth";
	Modelica.Blocks.Interfaces.RealOutput reaHeaBth_y(unit="W") = mod.reaHeaBth.y "Heating delivered to Bth";
	Modelica.Blocks.Interfaces.RealOutput conHeaBth_reaActHea_y(unit="1") = mod.conHeaBth.reaActHea.y "Actuator signal measurement for heating valve for zone Bth";
	...
	Modelica.Blocks.Interfaces.RealOutput conCooHal_reaCoo_y(unit="1") = mod.conCooHal.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Hal";
	...
	Modelica.Blocks.Interfaces.RealOutput conHeaRo2_reaActHea_y(unit="1") = mod.conHeaRo2.reaActHea.y "Actuator signal measurement for heating valve for zone Ro2";
	Modelica.Blocks.Interfaces.RealOutput conHeaRo3_reaActHea_y(unit="1") = mod.conHeaRo3.reaActHea.y "Actuator signal measurement for heating valve for zone Ro3";
	...
	Modelica.Blocks.Interfaces.RealOutput conHeaLiv_reaActHea_y(unit="1") = mod.conHeaLiv.reaActHea.y "Actuator signal measurement for heating valve for zone Liv";
	Modelica.Blocks.Interfaces.RealOutput conCooRo2_reaCoo_y(unit="1") = mod.conCooRo2.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Ro2";
	...
	Modelica.Blocks.Interfaces.RealOutput conHeaRo1_reaActHea_y(unit="1") = mod.conHeaRo1.reaActHea.y "Actuator signal measurement for heating valve for zone Ro1";
	...
	Modelica.Blocks.Interfaces.RealOutput conCooRo1_reaCoo_y(unit="1") = mod.conCooRo1.reaCoo.y "Cooling control signal measurement as fraction of maximum for zone Ro1";
