...
model FloorBase "Model of a floor of the building"
  ...
  Buildings.ThermalZones.Detailed.MixedAir sou(
    ...
    annotation (__Buildings(semantic(
      ...
      "bldg:<cdl_instance_name> a brick:Zone.")),
      Placement(transformation(extent={{144,-44},{184,-4}})));
  Buildings.ThermalZones.Detailed.MixedAir eas(
    ...
    annotation (__Buildings(semantic(
      metadataLanguage="Brick 1.3 text/turtle"
      "bldg:<cdl_instance_name> a brick:Zone.")),
      Placement(transformation(extent={{304,56},{344,96}})));
  Buildings.ThermalZones.Detailed.MixedAir nor(
    ...
    annotation (__Buildings(semantic(
      metadataLanguage="Brick 1.3 text/turtle"
      "bldg:<cdl_instance_name> a brick:Zone.")),
      Placement(transformation(extent={{144,116},{184,156}})));
  Buildings.ThermalZones.Detailed.MixedAir wes(
    ...
    annotation (__Buildings(semantic(
      metadataLanguage="Brick 1.3 text/turtle"
      "bldg:<cdl_instance_name> a brick:Zone.")),
      Placement(transformation(extent={{12,36},{52,76}})));
  Buildings.ThermalZones.Detailed.MixedAir cor(
    ...
    annotation (__Buildings(semantic(
      metadataLanguage="Brick 1.3 text/turtle"
      "bldg:<cdl_instance_name> a brick:Zone.")),
      Placement(transformation(extent={{144,36},{184,76}})));
