...
model Floor "Model of a floor of the building with CO2"
  extends MultiZoneOfficeSimpleAir.BaseClasses.PartialFloor(
...
equation
  ...
  connect(uSha.y,replicator. u) annotation (Line(
      ...
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  connect(CO2GenWes.y, wes.C_flow[1]) annotation (Line(points={{-89,60},{-38,60},
          {-38,58.8},{10.4,58.8}}, color={0,0,127}));
  connect(CO2GenCor.y, cor.C_flow[1]) annotation (Line(points={{103,66},{122,66},
          {122,58.8},{142.4,58.8}}, color={0,0,127}));
  connect(CO2GenEas.y, eas.C_flow[1]) annotation (Line(points={{275,74},{290,74},
          {290,78.8},{302.4,78.8}}, color={0,0,127}));
  connect(CO2GenNor.y, nor.C_flow[1]) annotation (Line(points={{101,152},{124,
          152},{124,138.8},{142.4,138.8}}, color={0,0,127}));
  connect(CO2GenSou.y, sou.C_flow[1]) annotation (Line(points={{105,-10},{124,
          -10},{124,-21.2},{142.4,-21.2}}, color={0,0,127}));
