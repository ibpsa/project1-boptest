...
equation
  ...
  connect(conEco.yOA, oveAhu.yOA_in) annotation (Line(points={{-58.6667,152},{
          74,152},{74,36.4286},{238,36.4286}},
                                            color={0,0,127}));
  connect(oveAhu.yOA_out, damExh.y) annotation (Line(points={{261,35},{278,35},
          {278,22},{-40,22},{-40,2}},          color={0,0,127}));
  ...
  connect(weaSta.weaBus, weaBus) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(oveCorSup.TZonHeaSet_out, conVAVCor.TRooHeaSet) annotation (Line(
        points={{439,-110},{448,-110},{448,-107},{454,-107}}, color={0,0,127}));
  connect(oveCorSup.TZonCooSet_out, conVAVCor.TRooCooSet) annotation (Line(
  ...
  connect(CO2Cor.y, reaCor.C_In) annotation (Line(points={{477,82},{508,82},{
          508,86.2222},{538,86.2222}},
                         color={0,0,127}));
  ...
  connect(oveSouLoc.yReaHea_out, gaiHeaCoiSou.u) annotation (Line(points={{701,-118},
        ...
        color={0,0,127}));
  connect(oveSouSup.TZonHeaSet_out, conVAVSou.TRooHeaSet) annotation (Line(
        points={{621,-110},{624.5,-110},{624.5,-107},{636,-107}}, color={0,0,
          127}));
  connect(oveSouSup.TZonCooSet_out, conVAVSou.TRooCooSet) annotation (Line(
  ...
  connect(CO2Sou.y, reaSou.C_In) annotation (Line(points={{665,80},{668,80},{
          668,86.2222},{718,86.2222}},
                         color={0,0,127}));
  ...
  connect(oveEasSup.TZonHeaSet_out, conVAVEas.TRooHeaSet) annotation (Line(
        points={{801,-110},{810,-110},{810,-107},{820,-107}}, color={0,0,127}));
  connect(oveEasSup.TZonCooSet_out, conVAVEas.TRooCooSet) annotation (Line(
  ...
  connect(CO2Eas.y, reaEas.C_In)
    annotation (Line(points={{835,82},{866,82},{866,86.2222},{898,86.2222}},
                                                 color={0,0,127}));
  ...
  connect(oveNorLoc.yReaHea_out, gaiHeaCoiNor.u) annotation (Line(points={{1061,
          ...
          127}));
  connect(oveNorSup.TZonHeaSet_out, conVAVNor.TRooHeaSet) annotation (Line(
        points={{981,-110},{988,-110},{988,-107},{994,-107}}, color={0,0,127}));
  connect(oveNorSup.TZonCooSet_out, conVAVNor.TRooCooSet) annotation (Line(
        points={{981,-118},{987.5,-118},{987.5,-114},{994,-114}}, color={0,0,
          127}));
  ...
  connect(CO2Nor.y, reaNor.C_In) annotation (Line(points={{1007,80},{1020,80},{
          1020,86.2222},{1078,86.2222}},
                          color={0,0,127}));
  ...
  connect(oveWesLoc.yReaHea_out, gaiHeaCoiWes.u) annotation (Line(points={{1249,
          ...
          127}));
  connect(oveWesSup.TZonHeaSet_out, conVAVWes.TRooHeaSet) annotation (Line(
        points={{1169,-110},{1172,-110},{1172,-107},{1184,-107}}, color={0,0,
          127}));
  connect(oveWesSup.TZonCooSet_out, conVAVWes.TRooCooSet) annotation (Line(
