...
equation
  ...
  connect(airHandlingUnit.qel, read_Q_el_fan.u) annotation (Line(points={{-146,
        ...
        color={0,0,127}));
  connect(districtHeating.qel, read_Q_el_pump.u) annotation (Line(points={{
          -121.4,-196},{70,-196},{70,-110},{78.4,-110}}, color={0,0,127}));
  connect(read_Q_el_fan.y, Qel_fan.u) annotation (Line(points={{96.8,-84},{106,
          -84},{106,-141},{124.2,-141}}, color={0,0,127}));
  connect(read_Q_el_pump.y, Qel_pmp.u) annotation (Line(points={{96.8,-110},{
  ...
  connect(read_Q_el_pump.y, add1.u2) annotation (Line(points={{96.8,-110},{106,
