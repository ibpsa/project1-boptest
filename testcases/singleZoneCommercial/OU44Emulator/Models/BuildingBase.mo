...
final parameter Modelica.SIunits.MassFlowRate m_flow_nominal_air=31
  ...
  model DistrictHeating
      ...
      redeclare Buildings.Fluid.Movers.Data.Pumps.Wilo.Stratos25slash1to4 per)
            ...
            rotation=90,
            origin={38,-38})));
      Buildings.Fluid.Sensors.MassFlowRate senMasFloDH(redeclare package
        Medium =
...
final parameter Buildings.HeatTransfer.Data.Solids.Generic insulationFloor(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemOut(redeclare package
      Medium =
        Air, m_flow_nominal=1)
...
connect(matrixGain.u[1], metHeat.y)
  ...
  connect(districtHeating.qdh, Qh_tot.u) annotation (Line(points={{-121.4,-208},
          {-22,-208},{-22,-204},{78,-204}}, color={0,0,127}));
