...
model BuildingControl
  ...
  Modelica.Blocks.Math.Product product
    annotation (Placement(transformation(extent={{152,-52},{136,-36}})));
  ...
  IBPSA.Utilities.IO.SignalExchange.Overwrite Over_CO2_setpoint(description=
        "Indoor CO2 concentration setpoint", u(min=400, max=1000))
                   "Overwrite CO2 setpoint" annotation (Placement(
        transformation(
        extent={{-8,-8},{8,8}},
        rotation=-90,
        origin={-208,112})));
equation
  ...
  connect(booleanToReal.y, product.u1) annotation (Line(points={{186.7,-11},{
          190,-11},{190,-39.2},{153.6,-39.2}}, color={0,0,127}));
  connect(product.u2, Tset.y) annotation (Line(points={{153.6,-48.8},{170,-48.8},
