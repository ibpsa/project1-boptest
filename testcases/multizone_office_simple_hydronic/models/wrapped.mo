model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfEmiHeaNz_u(unit="1", min=0.0, max=1.0) "North zone emission heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfEmiHeaNz_activate "Activation for North zone emission heating circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfEmiHeaSz_u(unit="1", min=0.0, max=1.0) "South zone emission heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfEmiHeaSz_activate "Activation for South zone emission heating circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuSupNz_u(unit="1", min=0.0, max=1.0) "North zone AHU supply fan setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuSupNz_activate "Activation for North zone AHU supply fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_oveTSupAhuHeaSz_u(unit="K", min=293.15, max=353.15) "South zone AHU heating water supply temperature setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_oveTSupAhuHeaNz_u(unit="K", min=293.15, max=353.15) "North zone AHU heating water supply temperature setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuHeaNz_u(unit="1", min=0.0, max=1.0) "North zone AHU heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuHeaNz_activate "Activation for North zone AHU heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfEmiCooSz_u(unit="1", min=0.0, max=1.0) "South zone emission cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfEmiCooSz_activate "Activation for South zone emission cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuRetNz_u(unit="1", min=0.0, max=1.0) "North zone AHU return fan setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuRetNz_activate "Activation for North zone AHU return fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfProHea_u(unit="1", min=0.0, max=1.0) "Heating production system supply temperature setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfProHea_activate "Activation for Heating production system supply temperature setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuCooNz_u(unit="1", min=0.0, max=1.0) "North zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuCooNz_activate "Activation for North zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuCooSz_u(unit="1", min=0.0, max=1.0) "South zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuCooSz_activate "Activation for South zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuSupSz_u(unit="1", min=0.0, max=1.0) "South zone AHU supply fan setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuSupSz_activate "Activation for South zone AHU supply fan setpoint";
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfEmiCooNz_u(unit="1", min=0.0, max=1.0) "North zone emission cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfEmiCooNz_activate "Activation for North zone emission cooling circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuRetSz_u(unit="1", min=0.0, max=1.0) "South zone AHU return fan setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuRetSz_activate "Activation for South zone AHU return fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_oveTSupEmiHeaSz_u(unit="K", min=293.15, max=353.15) "South zone heating emission circuit supply temperature setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_oveTSupEmiHeaNz_u(unit="K", min=293.15, max=353.15) "North zone heating emission circuit supply temperature setpoint";
	...
	Modelica.Blocks.Interfaces.RealInput bms_ovePrfAhuHeaSz_u(unit="1", min=0.0, max=1.0) "South zone AHU heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.BooleanInput bms_ovePrfAhuHeaSz_activate "Activation for South zone AHU heating circuit activation setpoint";
	// Out read
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfEmiHeaNz_y(unit="1") = mod.bms.ovePrfEmiHeaNz.y "North zone emission heating circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfEmiHeaSz_y(unit="1") = mod.bms.ovePrfEmiHeaSz.y "South zone emission heating circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuSupNz_y(unit="1") = mod.bms.ovePrfAhuSupNz.y "North zone AHU supply fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuHeaNz_y(unit="1") = mod.bms.ovePrfAhuHeaNz.y "North zone AHU heating circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfEmiCooSz_y(unit="1") = mod.bms.ovePrfEmiCooSz.y "South zone emission cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuRetNz_y(unit="1") = mod.bms.ovePrfAhuRetNz.y "North zone AHU return fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfProHea_y(unit="1") = mod.bms.ovePrfProHea.y "Heating production system supply temperature setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuCooNz_y(unit="1") = mod.bms.ovePrfAhuCooNz.y "North zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuCooSz_y(unit="1") = mod.bms.ovePrfAhuCooSz.y "South zone AHU cooling circuit activation setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuSupSz_y(unit="1") = mod.bms.ovePrfAhuSupSz.y "South zone AHU supply fan setpoint";
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfEmiCooNz_y(unit="1") = mod.bms.ovePrfEmiCooNz.y "North zone emission cooling circuit activation setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuRetSz_y(unit="1") = mod.bms.ovePrfAhuRetSz.y "South zone AHU return fan setpoint";
	...
	Modelica.Blocks.Interfaces.RealOutput bms_ovePrfAhuHeaSz_y(unit="1") = mod.bms.ovePrfAhuHeaSz.y "South zone AHU heating circuit activation setpoint";
	// Original model
	BuildingEmulators.BuildingSystem mod(
		...
		bms.oveValPosEmiHeaSz(uExt(y=bms_oveValPosEmiHeaSz_u),activate(y=bms_oveValPosEmiHeaSz_activate)),
		...
		bms.ovePrfAhuHeaSz(uExt(y=bms_ovePrfAhuHeaSz_u),activate(y=bms_ovePrfAhuHeaSz_activate))) "Original model with overwrites";
end wrapped;
