...
model ThreeZone "Example three-zone building structure model"
  ...
  IDEAS.Buildings.Components.Zone fF(
    V=216.0,
    nSurf=8,
    redeclare package Medium = Medium,
    airModel(massDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial))
  ...
  IDEAS.Buildings.Components.Zone sF(
    V=216.0,
    nSurf=8,
    redeclare package Medium = Medium,
    airModel(massDynamics=Modelica.Fluid.Types.Dynamics.DynamicFreeInitial))
  ...
  IDEAS.Buildings.Components.OuterWall[3] gF_ext(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-17.5,-75.5})));
  replaceable IDEAS.Buildings.Components.Window[3] gF_win(
    A={5.5,1,5.5},
    azi={IDEAS.Types.Azimuth.E,IDEAS.Types.Azimuth.S,IDEAS.Types.Azimuth.W},
  ...
  replaceable IDEAS.Buildings.Components.SlabOnGround gF_floor(
    A=72,
    PWall=26,
  ...
  IDEAS.Buildings.Components.OuterWall[3] fF_ext(
    redeclare IDEAS.Buildings.Data.Constructions.CavityWall constructionType,
    A={10,21,10},
    azi={IDEAS.Types.Azimuth.E,IDEAS.Types.Azimuth.S,IDEAS.Types.Azimuth.W},
    inc={IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall})
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-17.5,-15.5})));
  replaceable IDEAS.Buildings.Components.Window[3] fF_win(
    A={5.5,1,5.5},
    azi={IDEAS.Types.Azimuth.E,IDEAS.Types.Azimuth.S,IDEAS.Types.Azimuth.W},
    redeclare IDEAS.Buildings.Data.Glazing.Ins2Kr glazing,
    inc={IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall},
  ...
  IDEAS.Buildings.Components.OuterWall[3] sF_ext(
    redeclare IDEAS.Buildings.Data.Constructions.CavityWall constructionType,
    A={10,21,10},
    azi={IDEAS.Types.Azimuth.E,IDEAS.Types.Azimuth.S,IDEAS.Types.Azimuth.W},
    inc={IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall})
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-17.5,44.5})));
  replaceable IDEAS.Buildings.Components.Window[3] sF_win(
    A={5.5,1,5.5},
    azi={IDEAS.Types.Azimuth.E,IDEAS.Types.Azimuth.S,IDEAS.Types.Azimuth.W},
    redeclare IDEAS.Buildings.Data.Glazing.Ins2Kr glazing,
    inc={IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall,IDEAS.Types.Tilt.Wall},
