...
model BmsControl
    ...
    .Modelica.Blocks.Interfaces.RealOutput[nVen] TSupAhuSet annotation(Placement(transformation(extent = {{90.0,76.0},{110.0,96.0}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Blocks.Sources.RealExpression maxPrfProHea(y = if sum(prfAhuHea) + sum(prfEmiHea) > 0.5 then 1 else 0) annotation(Placement(transformation(extent = {{-36.28010648187601,151.719893518124},{-19.71989351812399,168.280106481876}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    ...
    connect(oveTSupAhuSz.y,TSupAhuSet[2]) annotation(Line(points = {{11.723949565574626,82},{58.07758977055067,82},{58.07758977055067,86},{100,86}},color = {0,0,127}));
    ...
    connect(ovePrfAhuSupSz.y,prfAhuSup[2]) annotation(Line(points = {{71.84748723340903,16},{71.84748723340903,30},{110,30}},color = {0,0,127}));
    ...
    connect(greaterOcc.y,boolToReaOcc.u) annotation(Line(points = {{-32.4653701434412,30.333333333333336},{1.7434413375193465,30.333333333333336},{1.7434413375193465,30},{35.95225281847989,30}},color = {255,0,255}));
    connect(ovePrfAhuSupNz.y,ovePrfAhuHeaNz.u) annotation(Line(points = {{71.84748723340903,30},{77.84748723340903,30},{77.84748723340903,7},{48.6841025150827,7},{48.6841025150827,-16},{53.62092301809924,-16}},color = {0,0,127}));
    connect(ovePrfAhuHeaNz.u,ovePrfAhuCooNz.u) annotation(Line(points = {{53.62092301809924,-16},{47.62092301809924,-16},{47.62092301809924,-54},{53.62092301809924,-54}},color = {0,0,127}));
    connect(ovePrfAhuSupSz.y,ovePrfAhuHeaSz.u) annotation(Line(points = {{71.84748723340903,16},{77.84748723340903,16},{77.84748723340903,27.315897484917286},{48.6841025150827,27.315897484917286},{48.6841025150827,-4},{53.62092301809924,-4}},color = {0,0,127}));
    connect(ovePrfAhuHeaSz.u,ovePrfAhuCooSz.u) annotation(Line(points = {{53.62092301809924,-4},{47.62092301809924,-4},{47.62092301809924,-42},{53.62092301809924,-42}},color = {0,0,127}));
    connect(greaterOcc.y,Occ) annotation(Line(points = {{-32.4653701434412,30.333333333333336},{59.767314928279404,30.333333333333336},{59.767314928279404,56},{110,56}},color = {255,0,255}));
