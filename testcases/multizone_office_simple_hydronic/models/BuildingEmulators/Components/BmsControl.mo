...
model BmsControl
    ...
    .IDEAS.Utilities.IO.SignalExchange.Overwrite oveTSupEmiCooSz(description = "South zone cooling emission circuit supply temperature setpoint", u( max=273.15+20,min=273.15+0, unit="K")) annotation(Placement(transformation(extent = {{-53.3158974849173,-113.31589748491729},{-42.6841025150827,-102.68410251508271}},origin = {0.0,0.0},rotation = 0.0)));
