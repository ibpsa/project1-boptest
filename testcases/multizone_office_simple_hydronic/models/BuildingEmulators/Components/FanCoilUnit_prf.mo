...
model FanCoilUnit_prf
  ...
  .Modelica.Blocks.Sources.RealExpression minSpe(y = 0) annotation (
    ...
    .Modelica.Blocks.Interfaces.IntegerInput prfEmiHea annotation(Placement(transformation(extent = {{-112.36070971046041,-28.360709710460426},{-87.63929028953959,-3.6392902895395736}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Interfaces.IntegerInput prfEmiCoo annotation(Placement(transformation(extent = {{-112.36070971046041,-48.360709710460426},{-87.63929028953959,-23.639290289539574}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Blocks.Interfaces.BooleanInput Occ annotation(Placement(transformation(extent = {{-111.10787837268762,-7.10787837268763},{-88.89212162731238,15.10787837268763}},origin = {0.0,0.0},rotation = 0.0)));
equation
  ...
  connect(cooCoi.port_b2, heaCoi.port_a2) annotation (
    ...
    connect(senTem.T,fcuInternalControl.TZon) annotation(Line(points = {{-71,50},{-71,-57},{-92,-57}},color = {0,0,127}));
