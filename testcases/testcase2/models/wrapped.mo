model wrapped "Wrapped model"
	...
	SingleZoneVAV.TestCaseSupervisory mod(
		oveTSetRooHea(uExt(y=oveTSetRooHea_u),activate(y=oveTSetRooHea_activate)),
		oveTSetRooCoo(uExt(y=oveTSetRooCoo_u),activate(y=oveTSetRooCoo_activate))) "Original model with overwrites";
