...
model AhuInternalControl
    ...
    .Modelica.Blocks.Logical.Greater greaterRet annotation(Placement(transformation(extent = {{-43.738931523723565,80.26106847627644},{-28.261068476276435,95.73893152372356}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Blocks.Logical.Less lessRet annotation(Placement(transformation(extent = {{-44.06850924225885,23.93149075774115},{-27.93149075774115,40.06850924225885}},origin = {0.0,0.0},rotation = 0.0)));
    ...
    .Modelica.Blocks.Logical.Hysteresis hystCoo(uLow = -0.5,uHigh = 0.25) annotation(Placement(transformation(extent = {{-18.998648648600845,-80.99864864860085},{-5.001351351399155,-67.00135135139915}},origin = {0.0,0.0},rotation = 0.0)));
...
equation
    ...
    connect(greaterRet.u1,TInAhu) annotation(Line(points = {{-45.286717828468284,88},{-74,88},{-74,80.24444444444444},{-100.53333333333333,80.24444444444444}},color = {0,0,127}));
    connect(greaterRet.u2,TRetAhu) annotation(Line(points = {{-45.286717828468284,81.80885478102115},{-60,81.80885478102115},{-60,40},{-100,40}},color = {0,0,127}));
    ...
    connect(TInAhu,lessRet.u1) annotation(Line(points = {{-100.53333333333333,80.24444444444444},{-74,80.24444444444444},{-74,32},{-45.68221109071062,32}},color = {0,0,127}));
    ...
    connect(lessRet.u2,TRetAhu) annotation(Line(points = {{-45.68221109071062,25.54519260619292},{-60,25.54519260619292},{-60,40},{-100,40}},color = {0,0,127}));
    connect(andRecCoo.u1,greaterRet.y) annotation(Line(points = {{-8.471092976159875,72},{-17.979134150031978,72},{-17.979134150031978,88},{-27.48717532390408,88}},color = {255,0,255}));
    ...
    connect(lessRet.y,andRecHea.u1) annotation(Line(points = {{-27.124639833515268,32},{-17.79786640483757,32},{-17.79786640483757,18},{-8.471092976159873,18}},color = {255,0,255}));
