...
<p>Figure 2 shows the fan characteristics. The grey line shows the operational point at nominal speed.</p>
...
<p>The layout of the hydronic heating system is shown in Figure 3. Piping segments are modelled between the main
    distribution pipes and the control valves for both the ventilation and radiator circuits.</p>
...
<ul>
    ...
    <li>
        <code>ovePum_u</code> [1] [min=0.0, max=50000.0]: Pump dP control signal for heating distribution system
    </li>
    <li>
