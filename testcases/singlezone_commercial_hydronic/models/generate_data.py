...
# remove unwanted forcasts
df = pd.read_csv(os.path.join(resources_dir, "weather.csv"))
df = df[["time", "pAtm", "lon", "lat", "HGloHor", "relHum", "winSpe", "winDir", "TDryBul"]]
gen.store_df(df, 'weather')
