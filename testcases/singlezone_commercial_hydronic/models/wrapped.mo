model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput reaValCoi_y(unit="1") = mod.reaValCoi.y "AHU heating coil valve control signal";
	...
	Modelica.Blocks.Interfaces.RealOutput reaValRad_y(unit="1") = mod.reaValRad.y "Radiator valve control signal";
