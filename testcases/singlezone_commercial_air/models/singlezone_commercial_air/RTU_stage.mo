...
model RTU_stage "Single staged RTU"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.DXCoil datCoi(
    ...
    annotation (Placement(transformation(extent={{74,78},{100,104}})));

  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.SingleSpeed   DX(
    redeclare package Medium = MediumA,
    dp_nominal=10,
    datCoi=datCoi,
  ...
  Modelica.Blocks.Logical.Hysteresis cooCoiCon1(uLow=0, uHigh=0.555)
...
equation
  ...
  connect(weaBus1, weaDat.weaBus) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(cooCoiCon.y, DX.on) annotation (Line(points={{-55,-42},{-28,-42},{-28,
          24.2},{-6.9,24.2}}, color={255,0,255}));
  connect(envelopeModel.Tz, varTz.u1) annotation (Line(points={{92,52.4},{106,
          52.4},{106,-56},{-122,-56},{-122,-36},{-112,-36}}, color={0,0,127}));
  connect(varTz.y, cooCoiCon.u)
    annotation (Line(points={{-89,-42},{-78,-42}}, color={0,0,127}));
  ...
  connect(envelopeModel.Tz, varTz1.u2) annotation (Line(points={{92,52.4},{108,
          52.4},{108,-104},{-126,-104},{-126,-86},{-116,-86}}, color={0,0,127}));
  connect(varTz1.y, cooCoiCon1.u)
    annotation (Line(points={{-93,-80},{-88,-80}}, color={0,0,127}));
  connect(cooCoiCon1.y, booleanToReal.u)
    annotation (Line(points={{-65,-80},{-48,-80}}, color={255,0,255}));
  connect(from_degC.y, varTz.u2) annotation (Line(points={{-127.7,-47},{-120.85,
          -47},{-120.85,-48},{-112,-48}}, color={0,0,127}));
  connect(from_degC1.y, varTz1.u1) annotation (Line(points={{-125.7,-75},{
          -120.85,-75},{-120.85,-74},{-116,-74}}, color={0,0,127}));
  ...
  connect(booleanToReal.y, hea.u) annotation (Line(points={{-25,-80},{-12,-80},
          {-12,-26},{8,-26}}, color={0,0,127}));
