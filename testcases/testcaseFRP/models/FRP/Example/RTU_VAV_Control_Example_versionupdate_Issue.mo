within FRP.Example;
model RTU_VAV_Control_Example_versionupdate_Issue "V5+Update BuildingsV8.1"
...
equation
  ...
  connect(splSupRoo1.port_3, vAVReHeat_withCtrl_TRooCon_v2_5.port_a)
    annotation (Line(points={{-60,491},{-56,491},{-56,191.2},{-16,191.2}},
        color={0,127,255}));
  ...
  connect(splSupRoo2.port_3, vAVReHeat_withCtrl_TRooCon_v2_1.port_a)
    annotation (Line(points={{28,489},{28,295.2},{38,295.2}}, color={0,127,255}));
  ...
  connect(splSupRoo3.port_3, vAVReHeat_withCtrl_TRooCon_v2_6.port_a)
    annotation (Line(points={{120,489},{120,185.2},{136,185.2}}, color={0,127,
          255}));
  ...
  connect(splSupRoo4.port_3, vAVReHeat_withCtrl_TRooCon_v2_9.port_a)
    annotation (Line(points={{210,489},{210,295.2},{218,295.2}}, color={0,127,
          255}));
  connect(splSupRoo4.port_2, vAVReHeat_withCtrl_TRooCon_v2_10.port_a)
    annotation (Line(points={{236,515},{302,515},{302,181.2},{322,181.2}},
        color={0,127,255}));
  ...
  connect(splRetRoo1.port_1, fRPMultiZone_Envelope_Icon.port_205[2])
    annotation (Line(points={{654,507},{634.497,507},{634.497,203.48}}, color={0,
          127,255}));
  connect(splRetRoo1.port_3, fRPMultiZone_Envelope_Icon.port_204[2])
    annotation (Line(points={{679,482},{679,265.8},{657.886,265.8}}, color={0,127,
          255}));
  ...
  connect(fRPMultiZone_Envelope_Icon.port_202[2], splRetRoo2.port_3)
    annotation (Line(points={{744.469,251.86},{765,251.86},{765,482}}, color={0,
          127,255}));
  ...
  connect(fRPMultiZone_Envelope_Icon.port_203[2], splRetRoo3.port_3)
    annotation (Line(points={{762.114,299.42},{845,299.42},{845,482}}, color={0,
          127,255}));
  ...
  connect(fRPMultiZone_Envelope_Icon.port_206[2], splRetRoo4.port_3)
    annotation (Line(points={{819.972,188.72},{925,188.72},{925,480}}, color={0,
          127,255}));
  ...
  connect(CoolingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_5.TRooCooSet)
    annotation (Line(points={{-114.3,459},{16.6667,459},{16.6667,223.6}}, color
        ={0,0,127}));
  ...
  connect(HeatingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_5.TRooHeaSet)
    annotation (Line(points={{-112.3,407},{-12.7333,407},{-12.7333,223}}, color
        ={0,0,127}));
  connect(HeatingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_1.TRooHeaSet)
    annotation (Line(points={{-112.3,407},{41.2667,407},{41.2667,327}}, color={
          0,0,127}));
  connect(HeatingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_6.TRooHeaSet)
    annotation (Line(points={{-112.3,407},{139.267,407},{139.267,217}}, color={
          0,0,127}));
  connect(HeatingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_9.TRooHeaSet)
    annotation (Line(points={{-112.3,407},{221.267,407},{221.267,327}}, color={
          0,0,127}));
  connect(HeatingSP2.y[1], vAVReHeat_withCtrl_TRooCon_v2_10.TRooHeaSet)
    annotation (Line(points={{-112.3,407},{325.267,407},{325.267,213}}, color={
          0,0,127}));
...
end RTU_VAV_Control_Example_versionupdate_Issue;
