...
model RTU_VAV_Control_Example_v4 "improve simulation robustness"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.VariableSpeed
    ...
    annotation (Placement(transformation(extent={{-632,-82},{-508,42}})));
...
equation
  connect(fan.port_b, DX.port_a) annotation (Line(points={{-720,-19},{-632,-19},
          {-632,-20}},      color={0,127,255}));
  ...
  connect(DX.port_b,eleHea. port_a) annotation (Line(points={{-508,-20},{-472,
          -20},{-472,-21},{-450,-21}},      color={0,127,255}));
  ...
  connect(DX.port_b,T_after_CC. port) annotation (Line(points={{-508,-20},{-496,
          -20},{-496,-18},{-486,-18}},       color={0,127,255}));
  ...
  connect(conDX.y, DX.speRat) annotation (Line(points={{-506.4,446},{-464,446},
          {-464,230},{-638,230},{-638,128},{-638.2,128},{-638.2,29.6}},
                                                       color={0,0,0},
      pattern=LinePattern.Dash));
