within FRP.Example;
model RTU_VAV_Control_Example_FRP_new_performance_map
  "v10. 0905.2024_based on FRP_v2 _performance map and system nominal values update"
    extends Modelica.Icons.Example;
    package MediumA = Buildings.Media.Air "Medium model";
    parameter Modelica.SIunits.MassFlowRate m_flow_nominal=1.8498; // kg/s
    parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal=34000; // Rated cooling capacity
    ...
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_102= 0.069376;  //kg/s
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_103= 0.069376;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_104= 0.21391;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_105= 0.21391;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_106= 0.21391;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_202= 0.121408;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_203= 0.08672;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_204= 0.21391;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_205= 0.21391;
    parameter Modelica.SIunits.MassFlowRate VAV_m_flow_nominal_206= 0.21391;
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.VariableSpeed
    ...
    speRatDeaBan=0.1)
                 "multi-stage DX unit"
    annotation (Placement(transformation(extent={{-638,-70},{-514,54}})));
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.DXCoil datCoi(
    ...
    sta={
        ...
        nomVal=
          ...
          Q_flow_nominal=-17000/34000*Q_flow_nominal,
          COP_nominal=2.843,
          SHR_nominal=0.9,
          m_flow_nominal=17000/34000*m_flow_nominal),
        perCur=FRP.RTUVAV.Performance_Stage1_New()),
        Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.BaseClasses.Stage(
        spe=3600/60,
        nomVal=
          Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.BaseClasses.NominalValues(
          ...
          SHR_nominal=0.809,
          m_flow_nominal=m_flow_nominal),
        perCur=FRP.RTUVAV.Performance_Stage2_New())})                                                                                               "Coil data"
    annotation (Placement(transformation(extent={{-1062,522},{-1000,584}})));
...
equation
  ...
  connect(weaBus1.TDryBul, TOA) annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(TOA,DX. TConIn) annotation (Line(points={{-734,159},{-660,159},{-660,10.6},
          {-644.2,10.6}},             color={0,0,127}));
  ...
  connect(minus.y, confan.u_m) annotation (Line(
      ...
      color={0,0,0},
      pattern=LinePattern.Dash));
  connect(confan.y, fan.y) annotation (Line(points={{-772.4,312},{-756,312},{-756,
          22.2},{-753,22.2}},      color={0,0,0},
      pattern=LinePattern.Dash));
  connect(fan.port_b, T_before_CC.port_a) annotation (Line(points={{-718,-15},{-710,
          -15},{-710,-19},{-700,-19}}, color={0,127,255}));
  connect(T_before_CC.port_b, DX.port_a) annotation (Line(points={{-666,-19},{-648,
          -19},{-648,-8},{-638,-8}},   color={0,127,255}));
  connect(DX.port_b, T_after_CC.port_a) annotation (Line(points={{-514,-8},{-504,
          -8},{-504,-15},{-496,-15}},       color={0,127,255}));
...
end RTU_VAV_Control_Example_FRP_new_performance_map;
