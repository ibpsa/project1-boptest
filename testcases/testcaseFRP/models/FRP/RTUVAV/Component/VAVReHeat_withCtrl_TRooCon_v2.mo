...
model VAVReHeat_withCtrl_TRooCon_v2
  ...
  Buildings.Controls.Continuous.LimPID         conHea(
    ...
    annotation (Placement(transformation(extent={{-116,58},{-96,78}})));
...
equation
  ...
  connect(TRoo, conCoo.u_m) annotation (Line(points={{-52,114},{-52,48},{24,48},
          {24,56}}, color={0,0,127}));
  connect(TRooHeaSet, conHea.u_s) annotation (Line(points={{-126,110},{-126,68},
          {-118,68}}, color={0,0,127}));
  connect(TRoo, conHea.u_m) annotation (Line(points={{-52,114},{-52,48},{-106,
          48},{-106,56}},      color={0,0,127}));
  connect(conHea.y, ReHeat.u) annotation (Line(points={{-95,68},{-90,68},{-90,
          22},{-73,22}},
                     color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},{100,
            100}})));
end VAVReHeat_withCtrl_TRooCon_v2;
