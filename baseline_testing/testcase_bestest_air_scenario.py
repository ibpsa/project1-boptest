# -*- coding: utf-8 -*-
"""
This script demonstrates baseline testing of test case called "bestest_air".
...
def run(modelname, scenario, start_time = 0, warmup_period = 0, length = 48*3600,  plot=False):
    ...
    zone_temperature = df_res['zon_reaTRooAir_y'].values - 273.15  # convert K --> C
    # Plot results
    if plot:
        try:
