...
equation
  ...
  connect(souTOut.y, read_Real.u[1])
    annotation (Line(points={{-79,60},{-62,60}}, color={0,0,127}));
  connect(read_Real.y[1], preTOut.T) annotation (Line(points={{-38.6,60},{-20,60},
          {-20,34},{-74,34},{-74,0},{-62,0}}, color={0,0,127}));
  connect(realExpression.y, preHeat.Q_flow) annotation (Line(points={{-79,-20},
          {-80,-20},{-80,-52},{0,-52}}, color={0,0,127}));
